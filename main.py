...
if not SECRET_KEY:
    ...
    # Force environment configuration for security.
...
class NLPModule:
    ...
    def __init__(self):
        """Initializes the NLP module with FLAN-T5."""
...
class CVModule:
    ...
    def __init__(self):
        """Initializes the CV module with YOLOv8."""
    ...
    def detect_objects(self, image: Image.Image) -> str:
        ...
        # YOLOv8 Results object .to_json() method
...
class SpeechProcessor:
    ...
    def speech_to_text(self, audio_file: UploadFile) -> str:
        ...
        # Whisper transcribe expects a file path or a numpy array.
        # We save the upload to a temp file and transcribe.
    ...
    def __del__(self):
        ...
        if hasattr(self, "tts"):
            try:
                ...
                logger.debug(f"Error stopping TTS: {exc}")
...
@app.post(
    "/process-cv-detection/", dependencies=[Depends(authenticate_user)]
)
